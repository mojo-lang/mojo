...
func (v *BaseProtobuf3Visitor) VisitRequestStream(ctx *RequestStreamContext) interface{} {
	return v.VisitChildren(ctx)
}

func (v *BaseProtobuf3Visitor) VisitResponseStream(ctx *ResponseStreamContext) interface{} {
	return v.VisitChildren(ctx)
}
