...
func (v *BaseMojoParserVisitor) VisitAttributeNameIdentifier(ctx *AttributeNameIdentifierContext) interface{} {
	return v.VisitChildren(ctx)
}
...
func (v *BaseMojoParserVisitor) VisitRange_right_open_operator(ctx *Range_right_open_operatorContext) interface{} {
	return v.VisitChildren(ctx)
}
