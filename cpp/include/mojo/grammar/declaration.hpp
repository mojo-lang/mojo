...
struct variable_declaration
    : pegtl::sor<pegtl::seq<identifier,
                            seps,
                            pegtl::sor<pegtl::seq<pegtl::one<':'>, initializer>,
                                       pegtl::seq<type_annotation, seps, initializer>>>,
                 pegtl::seq<key_var,
                            seps,
                            identifier,
                            seps,
...
struct interface_declaration
    : pegtl::seq<key_interface, seps, interface_declaration_clause> {};
