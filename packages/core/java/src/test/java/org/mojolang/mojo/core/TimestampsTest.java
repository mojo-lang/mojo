...
import static org.mojolang.mojo.core.DurationsTest.duration;
...
public class TimestampsTest {
    ...
    private static final Timestamp INVALID_MAX =
            Timestamp.newBuilder().setSeconds(Long.MAX_VALUE).setNanoseconds(Integer.MAX_VALUE).build();
    private static final Timestamp INVALID_MIN =
            Timestamp.newBuilder().setSeconds(Long.MIN_VALUE).setNanoseconds(Integer.MIN_VALUE).build();
    ...
    @Test
    public void testTimestampStringFormat() throws ErrorException, ParseException {
        ...
        assertThat(start.getNanoseconds()).isEqualTo(0);
        assertThat(end.getSeconds()).isEqualTo(Timestamps.TIMESTAMP_SECONDS_MAX);
        assertThat(end.getNanoseconds()).isEqualTo(999999999);
        ...
        assertThat(value.getNanoseconds()).isEqualTo(0);
        ...
        assertThat(value.getNanoseconds()).isEqualTo(999000000);
        ...
        value = Timestamp.newBuilder().setNanoseconds(10).build();
        assertThat(Timestamps.toString(value)).isEqualTo("1970-01-01T00:00:00.000000010Z");
        value = Timestamp.newBuilder().setNanoseconds(10000).build();
        assertThat(Timestamps.toString(value)).isEqualTo("1970-01-01T00:00:00.000010Z");
        value = Timestamp.newBuilder().setNanoseconds(10000000).build();
        ...
        public void run() {
            ...
            while (!stopParsingThreads) {
                ...
                if (result.getSeconds() != values[index].getSeconds()
                        || result.getNanoseconds() != values[index].getNanoseconds()) {
                    errorMessage =
    ...
    @Test
    public void testTimestampConcurrentParsing() throws ErrorException, ParseException, InterruptedException {
    ...
    @Test
    public void testTimestampInvalidFormatValueTooSmall() throws ErrorException {
        try {
            // Value too small.
            Timestamp value =
    ...
    @Test
    public void testTimestampInvalidFormatValueTooLarge() throws ErrorException {
        try {
            // Value too large.
            Timestamp value =
    ...
    @Test
    public void testTimestampInvalidFormatNanosTooSmall() throws ErrorException {
        try {
            // Invalid nanos value.
            Timestamp value = Timestamp.newBuilder().setNanoseconds(-1).build();
            Timestamps.toString(value);
            fail("IllegalArgumentException is expected.");
        } catch (IllegalArgumentException expected) {
        }
    ...
    @Test
    public void testTimestampInvalidFormatNanosTooLarge() throws ErrorException {
        try {
            // Invalid nanos value.
            Timestamp value = Timestamp.newBuilder().setNanoseconds(1000000000).build();
            Timestamps.toString(value);
            fail("IllegalArgumentException is expected.");
        } catch (IllegalArgumentException expected) {
        }
    ...
    @Test
    public void testTimestampConversion() throws ErrorException, ParseException {
    ...
    @Test
    public void testTimeOperations() throws ErrorException, ParseException {
        Timestamp start = Timestamps.parse("0001-01-01T00:00:00Z");
        Timestamp end = Timestamps.parse("9999-12-31T23:59:59.999999999Z");
    ...
    @Test
    public void testOverflowsArithmeticException() throws ErrorException, ParseException {
        try {
    ...
    static Timestamp timestamp(long seconds, int nanos) {
        return Timestamps.checkValid(
                Timestamps.checkValid(Timestamp.newBuilder().setSeconds(seconds).setNanoseconds(nanos)));
    }
}
