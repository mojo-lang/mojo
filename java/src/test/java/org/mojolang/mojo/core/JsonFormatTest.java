...
import org.mojolang.mojo.core.JsonFormat.TypeRegistry;
import org.mojolang.mojo.core.proto.JsonTestProto.TestAllTypes;
import org.mojolang.mojo.core.proto.JsonTestProto.TestAllTypes.AliasedEnum;
import org.mojolang.mojo.core.proto.JsonTestProto.TestAllTypes.NestedEnum;
import org.mojolang.mojo.core.proto.JsonTestProto.TestAllTypes.NestedMessage;
import org.mojolang.mojo.core.proto.JsonTestProto.TestCustomJsonName;
import org.mojolang.mojo.core.proto.JsonTestProto.TestDuration;
import org.mojolang.mojo.core.proto.JsonTestProto.TestFieldMask;
import org.mojolang.mojo.core.proto.JsonTestProto.TestMap;
import org.mojolang.mojo.core.proto.JsonTestProto.TestOneof;
import org.mojolang.mojo.core.proto.JsonTestProto.TestRecursive;
import org.mojolang.mojo.core.proto.JsonTestProto.TestStruct;
import org.mojolang.mojo.core.proto.JsonTestProto.TestTimestamp;
import org.mojolang.mojo.core.proto.JsonTestProto.TestWrappers;
import org.mojolang.mojo.core.proto.JsonTestProto2.TestAllTypesProto2;
...
public class JsonFormatTest {
    ...
    private void assertRoundTripEquals(Message message) throws ErrorException, InvalidProtocolBufferException {
        assertRoundTripEquals(message, TypeRegistry.getEmptyTypeRegistry());
    }

    private void assertRoundTripEquals(Message message, TypeRegistry registry) throws ErrorException, InvalidProtocolBufferException {
    ...
    private void assertRoundTripEquals(Message message, com.google.protobuf.TypeRegistry registry)
            throws ErrorException, InvalidProtocolBufferException {
        JsonFormat.Printer printer = JsonFormat.printer().usingTypeRegistry(registry);
        JsonFormat.Parser parser = JsonFormat.parser().usingTypeRegistry(registry);
        Message.Builder builder = message.newBuilderForType();
        parser.merge(printer.print(message), builder);
    ...
    @Test
    public void testAllFields() throws ErrorException, IOException {
    ...
    @Test
    public void testUnknownEnumValues() throws ErrorException, IOException {
    ...
    @Test
    public void testSpecialFloatValues() throws ErrorException, IOException {
        TestAllTypes message =
                TestAllTypes.newBuilder()
    ...
    @Test
    public void testParserAcceptStringForNumericField() throws ErrorException, IOException {
        TestAllTypes.Builder builder = TestAllTypes.newBuilder();
        mergeFromJson(
                "{\n"
                        + "  \"optionalInt32\": \"1234\",\n"
    ...
    @Test
    public void testParserAcceptFloatingPointValueForIntegerField() throws ErrorException, IOException {
    ...
    @Test
    public void testParserRejectOutOfRangeNumericValues() throws ErrorException, IOException {
    ...
    @Test
    public void testParserAcceptNull() throws ErrorException, IOException {
        TestAllTypes.Builder builder = TestAllTypes.newBuilder();
        mergeFromJson(
                "{\n"
                        + "  \"optionalInt32\": null,\n"
    ...
    @Test
    public void testNullInOneof() throws ErrorException, IOException {
        ...
        assertThat(message.getOneofNullValue()).isEqualTo(Nulls.instance());
    }

    @Test
    public void testNullFirstInDuplicateOneof() throws ErrorException, IOException {
        TestOneof.Builder builder = TestOneof.newBuilder();
    ...
    @Test
    public void testNullLastInDuplicateOneof() throws ErrorException, IOException {
        TestOneof.Builder builder = TestOneof.newBuilder();
    ...
    @Test
    public void testParserRejectDuplicatedFields() throws ErrorException, IOException {
    ...
    @Test
    public void testMapFields() throws ErrorException, IOException {
    ...
    @Test
    public void testMapNullValueIsRejected() throws ErrorException, IOException {
        try {
            TestMap.Builder builder = TestMap.newBuilder();
            mergeFromJson(
                    "{\n"
    ...
    @Test
    public void testMapEnumNullValueIsIgnored() throws ErrorException, IOException {
        TestMap.Builder builder = TestMap.newBuilder();
    ...
    @Test
    public void testParserAcceptNonQuotedObjectKey() throws ErrorException, IOException {
        TestMap.Builder builder = TestMap.newBuilder();
        mergeFromJson(
    ...
    @Test
    public void testWrappers() throws ErrorException, IOException {
        TestWrappers.Builder builder = TestWrappers.newBuilder();
        builder.getBoolValueBuilder().setVal(false);
        builder.getInt32ValueBuilder().setVal(0);
        builder.getInt64ValueBuilder().setVal(0);
        builder.getUint32ValueBuilder().setVal(0);
        builder.getUint64ValueBuilder().setVal(0);
        builder.getFloatValueBuilder().setVal(0.0f);
        builder.getDoubleValueBuilder().setVal(0.0);
        builder.getStringValueBuilder().setVal("");
        builder.getBytesValueBuilder().setVal(ByteString.EMPTY);
        ...
        builder.getBoolValueBuilder().setVal(true);
        builder.getInt32ValueBuilder().setVal(1);
        builder.getInt64ValueBuilder().setVal(2);
        builder.getUint32ValueBuilder().setVal(3);
        builder.getUint64ValueBuilder().setVal(4);
        builder.getFloatValueBuilder().setVal(5.0f);
        builder.getDoubleValueBuilder().setVal(6.0);
        builder.getStringValueBuilder().setVal("7");
        builder.getBytesValueBuilder().setVal(ByteString.copyFrom(new byte[] {8}));
        message = builder.build();
    ...
    @Test
    public void testTimestamp() throws ErrorException, IOException, ParseException {
    ...
    @Test
    public void testTimestampMergeError() throws ErrorException, IOException {
    ...
    @Test
    public void testDuration() throws ErrorException, ParseException, IOException {
    ...
    @Test
    public void testDurationMergeError() throws ErrorException {
    ...
    @Test
    public void testFieldMask() throws ErrorException, IOException {
        TestFieldMask message =
                TestFieldMask.newBuilder()
                        .setFieldMaskValue(FieldMasks.fromString("foo.bar,baz,foo_bar.baz"))
                        .build();
    ...
    @Test
    public void testStruct() throws ErrorException, IOException {
        // Build a struct with all possible values.
        TestStruct.Builder builder = TestStruct.newBuilder();
        Object.Builder structBuilder = builder.getStructValueBuilder();
        structBuilder.putVals("null_value", Value.newBuilder().setNullVal(Nulls.instance()).build());
        structBuilder.putVals("number_value", Value.newBuilder().setDoubleVal(1.25).build());
        structBuilder.putVals("string_value", Value.newBuilder().setStringVal("hello").build());
        Object.Builder subStructBuilder = Object.newBuilder();
        subStructBuilder.putVals("number_value", Value.newBuilder().setPositiveVal(1234).build());
        structBuilder.putVals(
                "struct_value", Value.newBuilder().setObjectVal(subStructBuilder.build()).build());
        Values.Builder listBuilder = Values.newBuilder();
        listBuilder.addVals(Value.newBuilder().setDoubleVal(1.125).build());
        listBuilder.addVals(Value.newBuilder().setNullVal(Nulls.instance()).build());
        structBuilder.putVals(
                "list_value", Value.newBuilder().setValuesVal(listBuilder.build()).build());
        ...
        builder.setValue(Value.newBuilder().setNullVal(Nulls.instance()).build());
        message = builder.build();
        assertThat(toJsonString(message)).isEqualTo("{\n" + "  \"value\": null\n" + "}");
        assertRoundTripEquals(message);
        ...
        listBuilder.addVals(Value.newBuilder().setDoubleVal(31831.125).build());
        listBuilder.addVals(Value.newBuilder().setNullVal(Nulls.instance()).build());
        message = builder.build();
        assertThat(toJsonString(message))
...
//    @Test
//    public void testAnyFieldsWithCustomAddedTypeRegistry() throws Exception, InvalidProtocolBufferException {
...
//    }
    ...
    @Test
    public void testParserMissingTypeUrl() throws ErrorException {
        try {
    ...
    @Test
    public void testParserUnexpectedTypeUrl() throws ErrorException {
        try {
            Any.Builder builder = Any.newBuilder();
            mergeFromJson(
                    "{\n"
    ...
    @Test
    public void testParserRejectTrailingComma() throws ErrorException {
        try {
            TestAllTypes.Builder builder = TestAllTypes.newBuilder();
            mergeFromJson("{\n" + "  \"optionalInt32\": 12345,\n" + "}", builder);
            assertWithMessage("Exception is expected.").fail();
    ...
    @Test
    public void testParserRejectInvalidBase64() throws ErrorException, IOException {
        TestAllTypes.Builder builder = TestAllTypes.newBuilder();
        try {
    ...
    @Test
    public void testParserAcceptBase64Variants() throws ErrorException, IOException {
        assertAccepts("optionalBytes", "AQI"); // No padding
        assertAccepts("optionalBytes", "-_w"); // base64Url, no padding
    }

    @Test
    public void testParserRejectInvalidEnumValue() throws ErrorException {
        try {
            TestAllTypes.Builder builder = TestAllTypes.newBuilder();
    ...
    @Test
    public void testParserUnknownFields() throws ErrorException {
        try {
            TestAllTypes.Builder builder = TestAllTypes.newBuilder();
            String json = "{\n" + "  \"unknownField\": \"XXX\"\n" + "}";
            JsonFormat.parser().merge(json, builder);
    ...
    @Test
    public void testParserIgnoringUnknownFields() throws ErrorException, InvalidProtocolBufferException {
        TestAllTypes.Builder builder = TestAllTypes.newBuilder();
        String json = "{\n" + "  \"unknownField\": \"XXX\"\n" + "}";
        JsonFormat.parser().ignoringUnknownFields().merge(json, builder);
    }
    ...
    @Test
    public void testParserIgnoringUnknownEnums() throws ErrorException, InvalidProtocolBufferException {
        TestAllTypes.Builder builder = TestAllTypes.newBuilder();
        String json = "{\n" + "  \"optionalNestedEnum\": \"XXX\"\n" + "}";
        JsonFormat.parser().ignoringUnknownFields().merge(json, builder);
    ...
    @Test
    public void testParserSupportAliasEnums() throws ErrorException, InvalidProtocolBufferException {
        TestAllTypes.Builder builder = TestAllTypes.newBuilder();
    ...
    @Test
    public void testUnknownEnumMap() throws ErrorException, InvalidProtocolBufferException {
        TestMap.Builder builder = TestMap.newBuilder();
        JsonFormat.parser()
    ...
    @Test
    public void testRepeatedUnknownEnum() throws ErrorException, InvalidProtocolBufferException {
        TestAllTypes.Builder builder = TestAllTypes.newBuilder();
        JsonFormat.parser()
                .ignoringUnknownFields()
    ...
    @Test
    public void testParserIntegerEnumValue() throws ErrorException, IOException {
    ...
    @Test
    public void testCustomJsonName() throws ErrorException, InvalidProtocolBufferException {
    ...
    @Test
    public void testHtmlEscape() throws ErrorException, IOException {
    ...
    @Test
    public void testDefaultValueOptionsProto3() throws ErrorException, InvalidProtocolBufferException {
    ...
    @Test
    public void testDefaultValueForSpecificFieldsOptionProto2() throws ErrorException, InvalidProtocolBufferException {
    ...
    @Test
    public void testPreservingProtoFieldNames() throws ErrorException, InvalidProtocolBufferException {
    ...
    @Test
    public void testPrintingEnumsAsInts() throws ErrorException, InvalidProtocolBufferException {
    ...
    @Test
    public void testOmittingInsignificantWhiteSpace() throws ErrorException, IOException {
        TestAllTypes message = TestAllTypes.newBuilder().setOptionalInt32(12345).build();
...
//    @Test
//    public void testEmptyWrapperTypesInAny() throws Exception, InvalidProtocolBufferException {
//        JsonFormat.TypeRegistry registry =
//                JsonFormat.TypeRegistry.newBuilder().add(TestAllTypes.getDescriptor()).build();
//        JsonFormat.Parser parser = JsonFormat.parser().usingTypeRegistry(registry);
//
...
//    }
    ...
    @Test
    public void testRecursionLimit() throws ErrorException, InvalidProtocolBufferException {
        String input =
                "{\n"
                        + "  \"nested\": {\n"
                        + "    \"nested\": {\n"
    ...
    @Test
    public void testJsonException_forwardsIOException() throws ErrorException {
    ...
    @Test
    public void testJsonException_forwardsJsonException() throws ErrorException {
    ...
    @Test
    public void testJsonObjectForPrimitiveField() throws ErrorException {
        TestAllTypes.Builder builder = TestAllTypes.newBuilder();
        try {
            mergeFromJson(
                    "{\n"
    ...
    @Test
    public void testSortedMapKeys() throws ErrorException, IOException {
        TestMap.Builder mapBuilder = TestMap.newBuilder();
    ...
    @Test
    public void testPrintingEnumsAsIntsChainedAfterIncludingDefaultValueFields() throws ErrorException, InvalidProtocolBufferException {
    ...
    @Test
    public void testPreservesFloatingPointNegative0() throws ErrorException, InvalidProtocolBufferException {
        TestAllTypes message =
