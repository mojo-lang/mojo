...
private static final long serialVersionUID = 0L;
  ...
  public static final class Builder extends
    ...
    private void buildPartialRepeatedFields(org.mojolang.mojo.db.sql.WindowClause result) {
      if (windowsBuilder_ == null) {
    ...
    private void buildPartial0(org.mojolang.mojo.db.sql.WindowClause result) {
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 82: {
              org.mojolang.mojo.db.sql.Window m =
                  input.readMessage(
                      org.mojolang.mojo.db.sql.Window.parser(),
                      extensionRegistry);
              if (windowsBuilder_ == null) {
                ensureWindowsIsMutable();
                windows_.add(m);
