...
private static final long serialVersionUID = 0L;
  ...
  public static final class Builder extends
    ...
    private void buildPartialRepeatedFields(org.mojolang.mojo.db.sql.WithClause result) {
      if (tablesBuilder_ == null) {
    ...
    private void buildPartial0(org.mojolang.mojo.db.sql.WithClause result) {
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 82: {
              org.mojolang.mojo.db.sql.TemporaryTable m =
                  input.readMessage(
                      org.mojolang.mojo.db.sql.TemporaryTable.parser(),
                      extensionRegistry);
              if (tablesBuilder_ == null) {
                ensureTablesIsMutable();
                tables_.add(m);
