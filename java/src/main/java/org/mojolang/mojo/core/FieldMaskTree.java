...
final class FieldMaskTree {
    ...
    public String toString() {
        return FieldMasks.toString(toFieldMask());
    }
     ...
     */
    void merge(Message source, Message.Builder destination, FieldMasks.MergeOptions options) {
    ...
    private static void merge(
            Node node, Message source, Message.Builder destination, FieldMasks.MergeOptions options) {
        if (source.getDescriptorForType() != destination.getDescriptorForType()) {
        ...
        for (Entry<String, Node> entry : node.children.entrySet()) {
            ...
            if (field.isRepeated()) {
                if (options.replaceRepeatedFields()) {
                    ...
                    for (java.lang.Object element : (List) source.getField(field)) {
