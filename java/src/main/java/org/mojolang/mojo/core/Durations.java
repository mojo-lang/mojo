...
import static org.mojolang.mojo.core.Timestamps.MICROS_PER_SECOND;
import static org.mojolang.mojo.core.Timestamps.MILLIS_PER_SECOND;
import static org.mojolang.mojo.core.Timestamps.NANOS_PER_MICROSECOND;
import static org.mojolang.mojo.core.Timestamps.NANOS_PER_MILLISECOND;
import static org.mojolang.mojo.core.Timestamps.NANOS_PER_SECOND;
...
public final class Durations {
    ...
    public static final Duration MIN_VALUE =
            Duration.newBuilder().setSeconds(DURATION_SECONDS_MIN).setNanoseconds(-999999999).build();

    /** A constant holding the maximum valid {@link Duration}, approximately {@code +10,000} years. */
    public static final Duration MAX_VALUE =
            Duration.newBuilder().setSeconds(DURATION_SECONDS_MAX).setNanoseconds(999999999).build();

    /** A constant holding the duration of zero. */
    public static final Duration ZERO = Duration.newBuilder().setSeconds(0L).setNanoseconds(0).build();
    ...
    private static enum DurationComparator implements Comparator<Duration>, Serializable {
        ...
        public int compare(Duration d1, Duration d2) {
            ...
            return (secDiff != 0) ? secDiff : Integer.compare(d1.getNanoseconds(), d2.getNanoseconds());
        }
    }
    ...
    public static boolean isValid(Duration duration) {
        return isValid(duration.getSeconds(), duration.getNanoseconds());
    }
    ...
    public static boolean isNegative(Duration duration) {
        checkValid(duration);
        return (duration.getSeconds() == 0) ? duration.getNanoseconds() < 0 : duration.getSeconds() < 0;
    }
    ...
    public static Duration checkValid(Duration duration) {
        ...
        int nanos = duration.getNanoseconds();
    ...
    /**
     * Convert Duration to string format. The string format will contain 3, 6, or 9 fractional digits
    ...
    public static double toSecondsAsDouble(Duration duration) {
        checkValid(duration);
        return duration.getSeconds() + duration.getNanoseconds() / 1e9;
    }
    ...
    public static long toMillis(Duration duration) {
        ...
        return checkedAdd(
                ...
                duration.getNanoseconds() / NANOS_PER_MILLISECOND);
    }
    ...
    public static long toMicros(Duration duration) {
        ...
        return checkedAdd(
                ...
                duration.getNanoseconds() / NANOS_PER_MICROSECOND);
    }
    ...
    public static long toNanos(Duration duration) {
        checkValid(duration);
        return checkedAdd(
                checkedMultiply(duration.getSeconds(), NANOS_PER_SECOND), duration.getNanoseconds());
    }
    ...
    public static Duration add(Duration d1, Duration d2) {
        ...
        checkValid(d2);
        return normalizedDuration(
                checkedAdd(d1.getSeconds(), d2.getSeconds()), checkedAdd(d1.getNanoseconds(), d2.getNanoseconds()));
    }
    ...
    public static Duration subtract(Duration d1, Duration d2) {
        ...
        return normalizedDuration(
                ...
                checkedSubtract(d1.getNanoseconds(), d2.getNanoseconds()));
    }
    ...
    static Duration normalizedDuration(long seconds, int nanos) {
        ...
        Duration duration = Duration.newBuilder().setSeconds(seconds).setNanoseconds(nanos).build();
